...
13. [Guides](./13-guides.md)
    ...
    3. [Handlebars](./13-guides.md#Handlebars)
       ...
       4. [Reference static assets](./13-guides.md#Reference-static-assets)
       5. [Dynamically render components](./13-guides.md#Dynamically-render-components)
       6. [Dynamically render out components that are not in the block folder.](./13-guides.md#Dynamically-render-out-components-that-are-not-in-the-block-folder)
       7. [Create a custom helper](./13-guides.md#Create-a-custom-helper)
    4. [Knockout](./13-guides.md#Knockout)
       1. [Apply bindings to a node](./13-guides.md#Apply-bindings-to-a-node)
       2. [Create a global state](./13-guides.md#Create-a-global-state)
       3. [Apply bindings to the entire component](./13-guides.md#Apply-bindings-to-the-entire-element)
