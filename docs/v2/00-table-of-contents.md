...
12. [Guides](./12-guides.md)
    ...
    2. [TypeScript](./12-guides.md#TypeScript)
       ...
       4. [Add a polyfill](./12-guides.md#Add-a-polyfill)
       5. [Get data from data-attributes](./12-guides.md#Get-data-from-data-attributes)
       6. [Get data from embedded json](./12-guides.md#Get-data-from-embedded-json)
       7. [Get data through a http-request](./12-guides.md#Get-data-through-a-http-request)
       8. [Update an entire section through a http-request](./12-guides.md#Update-an-entire-section-through-a-http-request)
           1. [The API returns HTML](./12-guides.md#The-API-returns-HTML)
           2. [The API returns JSON](./12-guides.md#The-API-returns-JSON) 
       9. [Sort or filter items already in the DOM.](./12-guides.md#Sort-or-filter-items-already-in-the-DOM)
    ...
    4. [Knockout](./12-guides.md#Knockout)
       1. [Apply bindings to a node](./12-guides.md#Apply-bindings-to-a-node)
       2. [Create a global state](./12-guides.md#Create-a-global-state)       
       3. [Apply bindings to the entire component](./12-guides.md#Apply-bindings-to-the-entire-element)
