...
Please have a look at the knockout documentation for more information about the [`text`](https://knockoutjs.com/documentation/text-binding.html) and [`html`](https://knockoutjs.com/documentation/html-binding.html)
bindings.
