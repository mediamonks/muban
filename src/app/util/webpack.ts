 ...
 */
export function getModuleContext(context:any, iterator?:(context:any, key:string, module:any) => void):[{[key:string]:any},any] {
	const modules = {};
 ...
 */
export function getChanged(reloadedContext:any, modules:{[key:string]:string}):Array<{key:string, content:any}> {
